...
Schedule.create(time: DateTime.now.strftime("%H:%M"), user_id: user1.id, habit_id: habit1.id, frequency: "Weekly", start_date: Faker::Date.backward(30), end_date: Faker::Date.forward(30) )
